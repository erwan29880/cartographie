...
class TSP_GA:
    ...
    elle prend en entrée une route, une distance, et tente une optimisation
    la fonction run définit le nombre d'itérations de l'algorithme
    """
...
if __name__ == "__main__":
    ...
    cls_graph = graph.Graph(creer_lieux_aleatoires=False)
